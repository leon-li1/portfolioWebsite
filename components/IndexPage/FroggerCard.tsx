...
export const FroggerCard = () => (
  <Card backgroundColor={COLORS.blue} offset={{ x: 120, y: 30 }} id="frogger">
      ...
      <HorziontalContainer>
        ...
        <RHS>
          ...
          <p>
            One of the most popular classic arcade game of the 80’s, Frogger is
            a game in which the player guides a frog into one of the five caves.
            The frog starts at the bottom of the screen and the caves are at the
            top of the screen so the player must navigate the frog across the
            screen while avoiding many different obstacles.
          </p>
