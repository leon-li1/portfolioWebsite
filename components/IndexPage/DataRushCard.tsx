...
export const DataRushCard = () => (
  <Card backgroundColor={COLORS.blue} offset={{ x: 120, y: 30 }} id="data-rush">
    ...
    <HorziontalContainer>
      ...
      <RHS>
        ...
        <p>
          ...
          controls eight pieces called links, four of them represent viruses and
          the other four represent pieces of data. The hackers race to either
          download four pieces of data or make the opposing hacker download four
          viruses.
        </p>
